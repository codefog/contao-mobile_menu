...
{mobile_menu_display_legend},mobile_menu_phones,mobile_menu_tablets,mobile_menu_breakpoint,mobile_menu_parentTogglers,mobile_menu_disableNavigation;
...
(
    ...
    'exclude'                 => true,
    'inputType'               => 'text',
    'eval'                    => array('rgxp'=>'digit', 'maxlength'=>4, 'tl_class'=>'clr'),
...
$GLOBALS['TL_DCA']['tl_module']['fields']['mobile_menu_parentTogglers'] = array
(
    'label'                   => &$GLOBALS['TL_LANG']['tl_module']['mobile_menu_parentTogglers'],
    'exclude'                 => true,
    'inputType'               => 'checkbox',
    'eval'                    => array('tl_class'=>'w50 m12'),
    'sql'                     => "char(1) NOT NULL default ''"
